...
export default function Entry({entry, element}){
    return(
        <article className="p-4 m-8 grid place-content-center">
            <h2 className="text-4xl font-bold p-4">{entry.title}</h2>
            <div className="grid grid-cols-3 md:max-w-3xl py-4">
                {element}
                <p className="p-4 text-lg col-span-2">{entry.description}</p>
            </div>
            <code>
